...
const string POST_FILE = "C:\\Users\\glokr\\...\\Server - Client.txt"; // Path for SERVER - CLIENT communication
const string GET_FILE = "C:\\Users\\glokr\\...\\Client - Server.txt";  // Path for CLIENT - SERVER communication
const string GET_CACHE = "C:\\Users\\glokr\\...\\SERVER\\CACHE.txt";   // Path for cache
...
int main(int argc, char *argv[])
{
    ...
    // Help
    if (strcmp(argv[1], "-h") == 0 || strcmp(argv[1], "-H") == 0 || strcmp(argv[1], "/h") == 0 || strcmp(argv[1], "/H") == 0)
    {
    ...
    // Continuous mode
    if (strcmp(argv[1], "-s") == 0 || strcmp(argv[1], "-S") == 0 || strcmp(argv[1], "/s") == 0 || strcmp(argv[1], "/S") == 0)
    {
        ContinuousMode();
    }
