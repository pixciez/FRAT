...
#include <memory> // rand, srand, exit
#include <string> 
#include <array>
#include <iostream>
#include <stdio.h>
#include <string>
#include <unistd.h> // sleep, chdir, getcwd, for linux 
#include <fstream>
#include <sstream> // string parsing stringstream break message into time and data
#include <chrono>


#include "AES.h" //enc cbc decrypt cbc
...
// EDIT THESE VALUES
const string POST_FILE = "C:\\Users\\glokr\\...\\Client - Server.txt"; // Path for client - serv communication
const string GET_FILE = "C:\\Users\\glokr\\...\\Server - Client.txt";  // Path for serv - client communication
const string GET_CACHE = "C:\\Users\\glokr\\Desktop\\...\\CLIENT\\CACHE.txt";   // Path for cache
